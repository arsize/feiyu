  ...
  data: {
    ...
    faqListAll: [
      [{
        ...
        title: '如何租用电池？',
        isShow: false,
        listCont: ['在小程序页面点击“我的”进入个人中心页面-->点击“我的电池”进入我的电池页面后点击“开通服务”-->进入缴纳电池押金页面后点击“确认开通”并缴纳电池押金及首月租金-->前往线下服务门店向工作人员出示个人二维码以获取并绑定电池。'],
      }, ],
      [{
          title: '如何充电？',
          isShow: false,
        ...
        },
        {
          ...
          title: '如何退电？',
          isShow: false,
          listCont: ['若不再使用电池，可以退回电池取回电池押金。', '在小程序页面点击“我的”进入个人中心页面-->点击“我的电池”进入我的电池页面后点击“退电池”-->携带电池前往小程序退电池页面所提示的退电门店-->将电池退给门店工作人员并向其出示个人二维码以解绑电池-->退电成功，退电成功后电池月租停止计费，此后可申请退回押金。'],
        }, {
          title: '如何退押金？',
          isShow: false,
          listCont: ['退电成功后在我的电池页面点击“退押金”进入退押金页面-->点击“继续退押金”-->提交申请后，系统会将押金原路返回至您的帐户。', '押金退回到帐时间会根据您选择的支付方式所对应的银行或第三方支付的处理流程不同而有所差别，通常情况下，退款到账需要1～7个工作日到账。押金是您使用本换电服务的前提之一，一旦退款成功您将无法享用本换电服务。'],
