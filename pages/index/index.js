...
Page({
  ...
  handlePopMessage(res) {
    console.log("handlePopMessageres", res)
    ...
    switch (code) {
      ...
      case 12:
        this.setData({
          popUpsContent: '押金已退还,预计1~7个工作日到账'
        })
        break;
      case 13:
        this.setData({
      ...
      case 15:
        HTTP({
          url: 'battery/user/getCardDays',
          methods: 'get',
          data: {}
        }).then(res => {
          const daysNum = Number(res.data);
          let popUpsContentCurr = '';
          if (daysNum > 3) {
            popUpsContentCurr = `套餐剩余时间 ｜ ${daysNum}天`;
          } else {
            popUpsContentCurr = '立即续费';
          }
          this.setData({
            popUpsContent: popUpsContentCurr,
          })
